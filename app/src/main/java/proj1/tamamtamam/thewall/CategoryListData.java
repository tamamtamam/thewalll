...
public class CategoryListData {
    ...
    public static HashMap<String, Integer> getIcon() {
        ...
        expandableListIcon.put("Electronics", R.drawable.ic_phone_android_black_24dp);
        expandableListIcon.put("Clothing", R.drawable.ic_watch_black_24dp);
        expandableListIcon.put("Sports & Leisure", R.drawable.ic_pool_black_24dp);
